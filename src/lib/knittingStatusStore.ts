...
export const INITIAL_KNITTING_STATUS_ORDERS: KnittingStatusOrder[] = [
  ...
  },
  {
    id: 'ks-ord-272277',
    orderNo: '272277',
    buyerName: 'VOGUE SOURCING LIMITED',
    teamLeader: 'Ahamed Hossain',
    fabrication: '100% Cotton 1x1 Spandex Rib & Single Jersey',
    knitStartDate: '22-Aug-2026',
    knitEndDate: '05-Sep-2026',
    reqQty: 348,
    greyQty: 391,
    production: 0,
    knitBalance: 391,
    items: [
      {
        ...
        fgsm: 280,
        fWidth: '53"',
        yarnCount: '30s Combed + 20D Spandex',
        gaugeDia: '18G x 30"',
        knitStartDate: '22-Aug-2026',
        knitEndDate: '28-Aug-2026',
        reqQty: 42,
  ...
  },
  {
    ...
    buyerName: 'H&M',
    teamLeader: 'Masud Rana',
    fabrication: '100% Organic Cotton Single Jersey',
    knitStartDate: '10-Aug-2026',
    knitEndDate: '24-Aug-2026',
    reqQty: 3450,
    greyQty: 3500,
    production: 1200,
    knitBalance: 2300,
